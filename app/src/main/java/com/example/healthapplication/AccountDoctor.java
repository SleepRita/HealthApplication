...
public class AccountDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.account_doctor);
        ...
        toggle = new ActionBarDrawerToggle(
                AccountDoctor.this, drawer, R.string.drawer_open, R.string.drawer_close);
        ...
        NavigationView myNavigationView = findViewById(R.id.nav_view_doctor);
        myNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id == R.id.profileMenu) {
                    ...
                    drawer.close();
                } else if (id == R.id.patientsMenu) {
                    OnClick4(findViewById(R.id.profileMenu));
                    actionBar.setTitle(R.string.patients);
                    drawer.close();
    ...
    public void OnClick3(View view)
    {
        ...
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.conteiner2,f3);
        ft.commit();
    }

    public void OnClick4(View view)
    {
        DoctorPatients f4 = new DoctorPatients();
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.conteiner2,f4);
        ft.commit();
    }
